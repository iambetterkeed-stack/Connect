...
-- AddForeignKey
ALTER TABLE "RoomMember" ADD CONSTRAINT "RoomMember_roomId_fkey" FOREIGN KEY ("roomId") REFERENCES "DirectMessageRoom"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_RoleMembers" ADD CONSTRAINT "_RoleMembers_B_fkey" FOREIGN KEY ("B") REFERENCES "ServerMember"("id") ON DELETE CASCADE ON UPDATE CASCADE;
